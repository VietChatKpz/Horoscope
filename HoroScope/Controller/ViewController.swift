...
//        let solar = SolarDate(dd: 23, mm: 3, yy: 2000, hour: 5, minute: 30)
...
//        print(menhIndex)
////        print(menhIndex, Menh(with: lunar.mm, chi: lunar.hhTxt.chi).chi)
//        let anThanIndex = AnThan.generateArray(startWith: .Menh)[11-menhIndex]
...
//        for chi in Chi.list {
//            let diaBan = DiaBan(id: chi.rawValue, cungVi: chi, cungThan: listAnThan[chi.rawValue], cungCuc: cucIndex + listAnThan[chi.rawValue].rawValue*10, trangSinh: .TrangSinh, locTon: .LucSi, thaiTue: .BachHo)
//            list.append(diaBan)
//        }
//        

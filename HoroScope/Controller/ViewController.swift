...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for chi in Chi.list {
            let diaBan = DiaBan(id: chi.rawValue, cungVi: chi, cungThan: listAnThan[chi.rawValue], cungCuc: cucIndex + listAnThan[chi.rawValue].rawValue*10, trangSinh: .TrangSinh)
            list.append(diaBan)
        }
